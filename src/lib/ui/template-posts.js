...
export const noteFunction = (post) => {
  const tmp = `<div class='box-post large2'>
      ...
      <h2 class='text-5'>${post.uid.key}dice
      ...
      <div class='count-like'><img src='img/corazon.png' alt='icono de like' class='img-menu align'>Like</div>
      <button class='btn-post' id='btn-edit-${post.id}'>Editar</button>
      <button class='btn-post' id='btn-deleted-${post.id}'>Eliminar</button></div>`;
